...
<template>
  <li class="nav-item dropdown theme">
    <a
      class="btn btn-link nav-link py-2 px-0 px-lg-2 dropdown-toggle d-flex align-items-center text-capitalize"
      id="lang-change"
      aria-expanded="false"
    ...
    >
      <li class="nav-item">
        <button
          ...
          @click.preventg="setLocale(locale.code)"
        >
          {{ locale.name }}
        </button>
      </li>
